...
public class GameDeathEvent extends Event {
    ...
    public GameDeathEvent(Player killed, Entity lastDamagerOrPlayer, String deathMessage, Location deathLocation, EntityDamageEvent.DamageCause cause, LinkedList<DamageInstance> causes) {
        this.killed = killed;
